            ...
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="font-medium text-gray-800">Form Builder CP</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left font-medium text-green-500">$12,499.77</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="shrink-0 rounded-full mr-2 sm:mr-3 bg-green-500">
                  ...
                  <div class="font-medium text-gray-800">Machine Learning A-Z</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div class="flex shrink-0 -space-x-3 -ml-px">
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left font-medium text-green-500">$4,227.09</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="font-medium text-gray-800">2021 Web Bootcamp</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div class="flex shrink-0 -space-x-3 -ml-px">
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left font-medium text-green-500">$2,499.77</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="shrink-0 rounded-full mr-2 sm:mr-3 bg-light-blue-500">
                    <svg class="w-9 h-9 fill-current text-indigo-50" viewBox="0 0 36 36">
                      <path d="M18 26a8 8 0 118-8 8.009 8.009 0 01-8 8zm0-14a6 6 0 100 12 6 6 0 000-12z" />
                    </svg>
                  </div>
                  <div class="font-medium text-gray-800">Digital Marketing Course</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div class="flex shrink-0 -space-x-3 -ml-px">
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left font-medium text-green-500">$2,224.09</div>
              </td>
            </tr>
            <!-- Row -->
            <tr>
              <td class="p-2 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="shrink-0 rounded-full mr-2 sm:mr-3 bg-red-500">
                    <svg class="w-9 h-9 fill-current text-indigo-50" viewBox="0 0 36 36">
                  ...
                  <div class="font-medium text-gray-800">Form Builder PRO</div>
                </div>
              </td>
              <td class="p-2 whitespace-nowrap">
                <div class="flex shrink-0 -space-x-3 -ml-px">
              ...
              <td class="p-2 whitespace-nowrap">
                <div class="text-left font-medium text-green-500">$1,949.72</div>
              </td>
            </tr>
          </tbody>
        </table>
