              ...
              <div class="max-w-md mx-auto w-full">
                <div class="relative">
                  ...
                  <ul class="relative flex justify-between w-full">
                    ...
                    <li>
                      <router-link class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-gray-100 text-gray-500" to="/onboarding-02">2</router-link>
                    </li>
                    <li>
                      <router-link class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-gray-100 text-gray-500" to="/onboarding-03">3</router-link>
                    </li>
                    <li>
                      <router-link class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-gray-100 text-gray-500" to="/onboarding-04">4</router-link>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <form>
                <div class="space-y-3 mb-8">
                  <label class="relative block cursor-pointer">
                    ...
                    <div class="flex items-center bg-white text-sm font-medium text-gray-800 p-4 rounded border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
