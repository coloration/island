        ...
        <div class="min-h-screen h-full flex flex-col after:flex-1">
          ...
          <div class="px-4 py-8">
            <div class="max-w-md mx-auto">
              ...
              <h1 class="text-3xl text-gray-800 font-bold mb-6">Tell us about your company ✨</h1>
              <!-- Form -->
              <form>
                <div class="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
                  <label class="flex-1 relative block cursor-pointer">
                    ...
                    <div class="h-full text-center bg-white px-4 py-6 rounded border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                      ...
                      <div class="font-medium text-gray-800 mb-1">Individual</div>
                  ...
                  <label class="flex-1 relative block cursor-pointer">
                    ...
                    <div class="h-full text-center bg-white px-4 py-6 rounded border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                      ...
                      <div class="font-medium text-gray-800 mb-1">Organization</div>
                      <div class="text-sm">Lorem ipsum is place text commonly used.</div>
                    </div>
                    <div class="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-400 rounded pointer-events-none" aria-hidden="true"></div>
                  </label>
                ...
                <div class="flex items-center justify-between space-x-6 mb-8">
                  ...
                  <div class="flex items-center">
                    <div class="form-switch">
                      ...
                      <label class="bg-gray-400" for="switch">
