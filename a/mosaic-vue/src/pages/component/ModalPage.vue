    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden bg-white">
      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <!-- Page header -->
          <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Modal ✨</h1>
          </div>
          ...
          <div class="border-t border-gray-200">
            ...
            <div class="space-y-8 mt-8">
              ...
              <!-- Basic -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Basic</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic id="basic-modal" :modalOpen="basicModalOpen" @close-modal="basicModalOpen = false" title="Basic Modal">
                      ...
                      <div class="px-5 pt-4 pb-1">
                        <div class="text-sm">
                          <div class="font-medium text-gray-800 mb-2">Let’s Talk Paragraph</div>
                          <div class="space-y-2">
                      ...
                      <div class="px-5 py-4">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="basicModalOpen = false">Close</button>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic id="scrollbar-modal" :modalOpen="scrollbarModalOpen" @close-modal="scrollbarModalOpen = false" title="Modal w/ Scroll Bar">
                      ...
                      <!-- Modal footer -->
                      <div class="sticky bottom-0 px-5 py-4 bg-white border-t border-gray-200">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="scrollbarModalOpen = false">Close</button>
                          <button class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">I Understand</button>
                        </div>
                      </div>
                    </ModalBasic>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalCookies id="cookies-modal" :modalOpen="cookiesModalOpen" @close-modal="cookiesModalOpen = false" title="We use cookies 🍪">
                      ...
                      <!-- Modal footer -->
                      <div class="flex flex-wrap justify-end space-x-2">
                        <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="cookiesModalOpen = false">Decline</button>
              ...
              <!-- Feedback -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Feedback</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                    ...
                    <ModalBlank id="success-modal" :modalOpen="successModalOpen" @close-modal="successModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          <!-- Modal header -->
                          <div class="mb-2">
                            <div class="text-lg font-semibold text-gray-800">Upgrade your Subscription?</div>
                          </div>
                          <!-- Modal content -->
                          ...
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="successModalOpen = false">Cancel</button>
                    ...
                    <ModalBlank id="danger-modal" :modalOpen="dangerModalOpen" @close-modal="dangerModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          <!-- Modal header -->
                          <div class="mb-2">
                            <div class="text-lg font-semibold text-gray-800">Delete 1 customer?</div>
                          </div>
                          <!-- Modal content -->
                          <div class="text-sm mb-10">
                            <div class="space-y-2">
                          ...
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="dangerModalOpen = false">Cancel</button>
                    ...
                    <ModalBlank id="info-modal" :modalOpen="infoModalOpen" @close-modal="infoModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          <!-- Modal header -->
                          <div class="mb-2">
                            <div class="text-lg font-semibold text-gray-800">Create new Event?</div>
                          </div>
                          <!-- Modal content -->
                          <div class="text-sm mb-10">
                            <div class="space-y-2">
                          ...
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="infoModalOpen = false">Cancel</button>
              ...
              <!-- Product -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Product</h2>
                <div class="flex flex-wrap items-center -m-1.5">
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic id="feedback-modal" :modalOpen="feedbackModalOpen" @close-modal="feedbackModalOpen = false" title="Send Feedback">
                      ...
                      <div class="px-5 py-4">
                        <div class="text-sm">
                          <div class="font-medium text-gray-800 mb-3">Let us know what you think 🙌</div>
                        </div>
                        <div class="space-y-3">
                          <div>
                      ...
                      <div class="px-5 py-4 border-t border-gray-200">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="feedbackModalOpen = false">Cancel</button>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalAction id="newsletter-modal" :modalOpen="newsletterModalOpen" @close-modal="newsletterModalOpen = false">
                      ...
                      <div class="mb-2 text-center">
                        ...
                        <div class="text-lg font-semibold text-gray-800">Subscribe to the Newsletter!</div>
                      </div>
                      <!-- Modal content -->
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalAction id="announcement-modal" :modalOpen="announcementModalOpen" @close-modal="announcementModalOpen = false">
                      ...
                      <div class="mb-2 text-center">
                        ...
                        <div class="text-lg font-semibold text-gray-800">You Unlocked Level 2!</div>
                      </div>
                      <!-- Modal content -->
                      <div class="text-center">
                        <div class="text-sm mb-5">
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalAction id="integration-modal" :modalOpen="integrationModalOpen" @close-modal="integrationModalOpen = false">
                      ...
                      <div class="mb-5 text-center">
                        ...
                        <div class="text-lg font-semibold text-gray-800">Connect Mosaic with your Cruip account</div>
                      </div>
                      <!-- Modal content -->
                      <div class="text-sm mb-5">
                        <div class="font-medium text-gray-800 mb-3">Mosaic would like to:</div>
                        ...
                        <div class="text-xs text-gray-500">By clicking on Allow access, you authorize Mosaic to use your information in accordance with its <a class="text-indigo-500 hover:text-indigo-600" href="#0">Privacy Policy</a>. You can stop it at any time on the integrations page of your Mosaic account.</div>
                      </div>
                      <!-- Modal footer -->
                      <div class="flex flex-wrap justify-end space-x-2">
                        <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="integrationModalOpen = false">Cancel</button>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBlank id="news-modal" :modalOpen="newsModalOpen" @close-modal="newsModalOpen = false">
                      <div class="relative">
                        ...
                        <!-- Close button -->
                        <button class="absolute top-0 right-0 mt-5 mr-5 text-gray-50 hover:text-white" @click.stop="newsModalOpen = false">
                      ...
                      <div class="p-5">
                        ...
                        <div class="mb-2">
                          ...
                          <div class="text-lg font-semibold text-gray-800">Help your team work faster with X 🏃‍♂️</div>
                        </div>
                        <!-- Modal content -->
                        <div class="text-sm mb-5">
                          <div class="space-y-2">
                      ...
                      <div class="px-5 pt-4 pb-1">
                        <div class="text-sm">
                          ...
                          <ul class="space-y-2 mb-4">
                                ...
                                <div class="flex items-center">
                                  ...
                                  <div class="grow">
                                    <div class="flex flex-wrap items-center justify-between mb-0.5">
                                      <span class="font-medium text-gray-800">Mosaic Light <span class="text-xs italic text-gray-500 align-top">Current Plan</span></span>
                                      <span><span class="font-medium text-green-600">$39.00</span>/mo</span>
                                    </div>
                            ...
                            <li>
                              <button class="w-full h-full text-left py-3 px-4 rounded bg-white border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                                <div class="flex items-center">
                                  <div class="w-4 h-4 border-2 border-gray-300 rounded-full mr-3"></div>
                                  <div class="grow">
                                    <div class="flex flex-wrap items-center justify-between mb-0.5">
                                      <span class="font-semibold text-gray-800">Mosaic Basic <span class="text-xs italic text-indigo-500 align-top">Best Value ✨</span></span>
                                      <span><span class="font-medium text-green-600">$59.00</span>/mo</span>
                                    </div>
                            ...
                            <li>
                              <button class="w-full h-full text-left py-3 px-4 rounded bg-white border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                                <div class="flex items-center">
                                  ...
                                  <div class="grow">
                                    <div class="flex flex-wrap items-center justify-between mb-0.5">
                                      <span class="font-semibold text-gray-800">Mosaic Plus</span>
                                      <span><span class="font-medium text-green-600">$79.00</span>/mo</span>
                                    </div>
                          ...
                          <div class="text-xs text-gray-500">Your workspace’s Mosaic Light Plan is set to $39 per month and will renew on August 9, 2021.</div>
                        </div>
                      </div>
                      <!-- Modal footer -->
                      <div class="px-5 py-4">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-gray-200 hover:border-gray-300 text-gray-600" @click.stop="planModalOpen = false">Cancel</button>
