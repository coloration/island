    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden bg-white">
      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <!-- Page header -->
          <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Alert & Banner ✨</h1>
          </div>
          ...
          <div class="border-t border-gray-200">
            ...
            <div class="space-y-8 mt-8">
              ...
              <!-- Banner -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Banner</h2>
                <div class="space-y-3">
              ...
              <!-- Banner 2 -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Banner 2</h2>
                <div class="space-y-3">
              ...
              <!-- Toast -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Toast</h2>
                <div class="space-y-3">
              ...
              <!-- Toast 2 -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Toast 2</h2>
                <div class="space-y-3">
              ...
              <!-- Toast 3 -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Toast 3</h2>
                <div class="space-y-3">
              ...
              <div>
                ...
                <div class="space-y-3">
                  ...
                  <Notification type="warning" :open="notificationWarningOpen">
                    <div class="font-medium text-gray-800 mb-1">Merged Pull Request</div>
