        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="border-t border-gray-200">
            ...
            <div class="space-y-8 mt-8">
              ...
              <!-- Input Types -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Input Types</h2>
                    ...
                    <div>
                      <div class="flex items-center justify-between">
                        ...
                        <Tooltip class="ml-2" bg="dark" size="md">
                          <div class="text-sm text-gray-200">Excepteur sint occaecat cupidata non proident, sunt.</div>
                        </Tooltip>
                      </div>
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                          <span class="text-sm text-gray-400 font-medium px-3">USD</span>
                        </div>
                      </div>
                    </div>
                    <!-- End -->
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <div class="absolute inset-0 left-auto flex items-center pointer-events-none">
                          <span class="text-sm text-gray-400 font-medium px-3">%</span>
                        </div>
                      </div>
                    </div>
                    <!-- End -->
                  ...
                  <div>
                    ...
                    <form>
                      ...
                      <div class="relative">
                        ...
                        <div class="absolute inset-0 right-auto flex items-center pointer-events-none">
                          <svg class="w-4 h-4 fill-current text-gray-400 shrink-0 ml-3 mr-2" viewBox="0 0 16 16">
              ...
              <!-- Input Sizes -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Input Sizes</h2>
                <div class="grid gap-5 md:grid-cols-3">
              ...
              <!-- Input States -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Input States</h2>
                <div class="grid gap-5 md:grid-cols-3">
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <input id="disabled" class="form-input w-full disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-400 disabled:cursor-not-allowed" type="text" placeholder="Something cool..." disabled />
                    </div>
                    <!-- End -->
                  </div>
              ...
              <!-- Select -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Select</h2>
              ...
              <!-- Checkbox -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Checkbox</h2>
                <div class="flex flex-wrap items-center -m-3">
                  ...
                  <div class="m-3">
                    <!-- Start -->
                    <label class="flex items-center">
                      <input type="checkbox" class="form-checkbox disabled:bg-gray-50" disabled />
              ...
              <!-- Radio -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Radio</h2>
                <div class="flex flex-wrap items-center -m-3">
                  ...
                  <div class="m-3">
                    <!-- Start -->
                    <label class="flex items-center">
                      <input type="radio" name="radio-buttons" class="form-radio disabled:bg-gray-50" disabled />
                      <span class="text-sm ml-2">Disabled</span>
                    </label>
                    <!-- End -->
                  </div>
              ...
              <!-- Toggle Switch -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Toggle Switch</h2>
                <div class="flex flex-wrap items-center -m-3">
                  ...
                  <div class="m-3 w-24">
                    ...
                    <div class="flex items-center mt-5">
                      <div class="form-switch">
                        ...
                        <label class="bg-gray-400" for="toggle1">
                          <span class="bg-white shadow-sm" aria-hidden="true"></span>
                          <span class="sr-only">Toggle</span>
                        </label>
                      </div>
                      <div class="text-sm text-gray-400 italic ml-2">{{toggle1}}</div>
                    </div>
                    <!-- End -->
                  </div>
                  ...
                  <div class="m-3 w-24">
                    ...
                    <div class="flex items-center mt-5">
                      <div class="form-switch">
                        ...
                        <label class="bg-gray-400" for="toggle2">
                          <span class="bg-white shadow-sm" aria-hidden="true"></span>
                          <span class="sr-only">Toggle</span>
                        </label>
                      </div>
                      <div class="text-sm text-gray-400 italic ml-2">{{toggle2}}</div>
                    </div>
                    <!-- End -->
                  </div>
                  ...
                  <div class="m-3 w-32">
                    ...
                    <div class="flex items-center mt-5">
                      <div class="form-switch">
                        ...
                        <label class="bg-gray-400" for="toggle3">
                          <span class="bg-white shadow-sm" aria-hidden="true"></span>
                          <span class="sr-only">Toggle</span>
                        </label>
                      </div>
                      <div class="text-sm text-gray-400 italic ml-2">Disabled</div>
                    </div>                    
                    <!-- End -->
                  </div>
