    ...
    <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden bg-white">
      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <!-- Page header -->
          <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Accordion ✨</h1>
          </div>
          ...
          <div class="border-t border-gray-200">
            ...
            <div class="space-y-8 mt-8">
              ...
              <!-- Basic Accordion -->
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Basic Accordion</h2>
              ...
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Table Row with Accordion</h2>
                <!-- Start -->
              ...
              <div>
                <h2 class="text-2xl text-gray-800 font-bold mb-6">Rich Table Row with Accordion</h2>
                <!-- Start -->
                <div class="rounded-sm border border-gray-200">
                  <div class="overflow-x-auto">
                    <table class="table-auto w-full divide-y divide-gray-200">
