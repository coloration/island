      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="max-w-3xl m-auto">
            ...
            <!-- Page title -->
            <div class="mb-5">
              <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">👋 How we can help you today?</h1>
            </div>
            ...
            <div class="mb-6">
              <form class="relative">
                ...
                <input id="action-search" class="form-input pl-9 py-3 focus:border-gray-300 w-full" type="search" />
            ...
            <div class="mb-8 border-b border-gray-200">
              <ul class="text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
                ...
                <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                  <a class="text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Accessibility</a>
                </li>
                <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                  <a class="text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Marketing</a>
                </li>
                <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                  <a class="text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Development</a>
                </li>
                <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                  <a class="text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Account</a>
                </li>
              </ul>
            </div>
            ...
            <!-- Posts -->
            <div>
              <h2 class="text-2xl text-gray-800 font-bold mb-4">Popular Questions</h2>
              <!-- Post -->
              <article class="py-4 border-b border-gray-200">
                ...
                <div class="pl-7">
                  ...
                  <ul class="flex flex-wrap">
                    <li class="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-gray-400 after:px-2">
              ...
              <article class="py-4 border-b border-gray-200">
                <header class="flex items-start mb-2">
                  ...
                  <h3 class="text-xl leading-snug text-gray-800 font-bold">What would happen if I choose not to pay after the usage?</h3>
                </header>
                <div class="pl-7">
                  <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam, quis nostrud exercitation ullamco.</div>
                  <ul class="flex flex-wrap">
              ...
              <article class="py-4 border-b border-gray-200">
                <header class="flex items-start mb-2">
                  ...
                  <h3 class="text-xl leading-snug text-gray-800 font-bold">What limitations do trial accounts have?</h3>
                </header>
                <div class="pl-7">
                  <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam, quis nostrud exercitation ullamco.</div>
                  <ul class="flex flex-wrap">
              ...
              <article class="py-4 border-b border-gray-200">
                <header class="flex items-start mb-2">
                  ...
                  <h3 class="text-xl leading-snug text-gray-800 font-bold">Is there any difference between Standard and Plus licenses?</h3>
                </header>
                <div class="pl-7">
                  <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam, quis nostrud exercitation ullamco.</div>
                  <ul class="flex flex-wrap">
              ...
              <article class="py-4 border-b border-gray-200">
                <header class="flex items-start mb-2">
                  ...
                  <h3 class="text-xl leading-snug text-gray-800 font-bold">Is my personal information protected?</h3>
                </header>
                <div class="pl-7">
                  <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam, quis nostrud exercitation ullamco.</div>
                  <ul class="flex flex-wrap">
              ...
              <article class="py-4 border-b border-gray-200">
                <header class="flex items-start mb-2">
                  ...
                  <h3 class="text-xl leading-snug text-gray-800 font-bold">What can I create with with this product?</h3>
                </header>
                <div class="pl-7">
                  <div class="mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua ut enim ad minim veniam, quis nostrud exercitation ullamco.</div>
                  <ul class="flex flex-wrap">
            ...
            <div class="mt-6">
              <div class="flex justify-end">
                <a class="btn bg-white border-gray-200 hover:border-gray-300 text-indigo-500" href="#0">See All Questions -&gt;</a>
              </div>
            </div>
