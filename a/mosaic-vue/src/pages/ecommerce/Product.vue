      ...
      <main>
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
          ...
          <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
              <div class="mb-3">
                <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">&lt;- Back To Listing</a>
              </div>
              <header class="mb-4">
                <!-- Title -->
                <h1 class="text-2xl md:text-3xl text-gray-800 font-bold mb-2">Front-End Learning: Hands-On HTML & CSS In Real Web Apps ✨</h1>
              ...
              <div class="space-y-3 sm:flex sm:items-center sm:justify-between sm:space-y-0 mb-6">
                ...
                <div class="flex items-center sm:mr-4">
                  ...
                  <a class="block text-sm font-semibold text-gray-800 whitespace-nowrap" href="#0">
                    Simona Lürwer
                  </a>
                </div>
                <!-- Right side -->
              ...
              <!-- Image -->
              <figure class="mb-6">
                <img class="w-full rounded-sm" src="../../images/product-image.jpg" width="640" height="360" alt="Product" />
              </figure>
              ...
              <!-- Reviews -->
              <div>
                <h2 class="text-xl leading-snug text-gray-800 font-bold mb-2">Featured Reviews (44)</h2>
                <ul class="space-y-5 my-6">
                  <!-- Review -->
                  <li>
                    <div class="flex items-center mb-2">
                      <img class="w-8 h-8 rounded-full mr-3" src="../../images/user-32-07.jpg" width="32" height="32" alt="User 07" />
                      <div>
                        <div class="text-sm font-semibold text-gray-800 mb-1">Danielle Mark</div>
                        <!-- Rating -->
                  ...
                  <li>
                    <div class="flex items-center mb-2">
                      <img class="w-8 h-8 rounded-full mr-3" src="../../images/user-32-05.jpg" width="32" height="32" alt="User 05" />
                      <div>
                        <div class="text-sm font-semibold text-gray-800 mb-1">Marija Urkjulz</div>
                        <!-- Rating -->
                        <div class="flex items-center space-x-2">
                          <!-- Stars -->
                          <div class="flex space-x-1">
                          ...
                          <!-- Rate -->
                          <div class="inline-flex text-sm font-medium text-yellow-600">4.9</div>
                        </div>
                      </div>
                    </div>
                    <div class="text-sm italic">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.”</div>
                  ...
                  <li>
                    <div class="flex items-center mb-2">
                      <img class="w-8 h-8 rounded-full mr-3" src="../../images/user-32-03.jpg" width="32" height="32" alt="User 03" />
                      <div>
                        <div class="text-sm font-semibold text-gray-800 mb-1">Rodrigo Pantoja</div>
                        <!-- Rating -->
                        <div class="flex items-center space-x-2">
                          <!-- Stars -->
                          <div class="flex space-x-1">
                          ...
                          <!-- Rate -->
                          <div class="inline-flex text-sm font-medium text-yellow-600">4.4</div>
                        </div>
                      </div>
                    </div>
                    <div class="text-sm italic">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.”</div>
                  ...
                  <li>
                    <div class="flex items-center mb-2">
                      <img class="w-8 h-8 rounded-full mr-3" src="../../images/user-32-04.jpg" width="32" height="32" alt="User 04" />
                      <div>
                        <div class="text-sm font-semibold text-gray-800 mb-1">Juan Johnson</div>
                        <!-- Rating -->
                        <div class="flex items-center space-x-2">
                          <!-- Stars -->
                          <div class="flex space-x-1">
                ...
                <div class="text-center">
                  <button class="btn bg-white border-gray-200 hover:border-gray-300 text-indigo-500 hover:text-gray-600">Load More Reviews</button>
                </div>
              </div>
              ...
              <!-- Related -->
              <div>
                <h2 class="text-xl leading-snug text-gray-800 font-bold mb-2">Frequently Bought Together</h2>
                <ul class="space-y-8 sm:space-y-5 my-6">
                  ...
                  <li class="sm:flex items-center">
                    ...
                    <div class="grow">
                      <a href="#0">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">The Complete Front-End Development Course!</h3>
                      </a>
                      ...
                      <div class="flex flex-wrap items-center space-x-2">
                        ...
                        <!-- Price -->
                        <div>
                          <div class="inline-flex text-sm font-medium bg-green-100 text-green-600 rounded-full text-center px-2 py-0.5">$89.00</div>
                        </div>
                      </div>
                    </div>
                  </li>
                  ...
                  <li class="sm:flex items-center">
                    ...
                    <div class="grow">
                      <a href="#0">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">Web Development Ultimate Course 2021</h3>
                      </a>
                      <div class="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.</div>
                      <!-- Rating and price -->
                      <div class="flex flex-wrap items-center space-x-2">
                  ...
                  <li class="sm:flex items-center">
                    ...
                    <div class="grow">
                      <a href="#0">
                        <h3 class="text-lg font-semibold text-gray-800 mb-1">Full-Stack JavaScript Course!</h3>
                      </a>
                      <div class="text-sm mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut.</div>
                      <!-- Rating and price -->
                      <div class="flex flex-wrap items-center space-x-2">
                ...
                <!-- Load More -->
                <div class="text-center">
                  <button class="btn bg-white border-gray-200 hover:border-gray-300 text-indigo-500 hover:text-gray-600">Load More Stuff</button>
                </div>
              </div>
                ...
                <ul class="space-y-2 sm:flex sm:space-y-0 sm:space-x-2 lg:space-y-2 lg:space-x-0 lg:flex-col mb-4">
                  <li>
                    <button class="w-full h-full text-left py-3 px-4 rounded bg-white border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                      <div class="flex flex-wrap items-center justify-between mb-0.5">
                        <span class="font-semibold text-gray-800">Essential</span>
                        <span class="font-medium text-green-600">$39.00</span>
                      </div>
                  ...
                  <li>
                    <button class="w-full h-full text-left py-3 px-4 rounded bg-white border-2 border-indigo-400 shadow-sm duration-150 ease-in-out">
                      <div class="flex flex-wrap items-center justify-between mb-0.5">
                        <span class="font-semibold text-gray-800">Premium <span class="text-xs italic text-indigo-500 align-top">Best Value ✨</span></span>
                        <span class="font-medium text-green-600">$69.00</span>
                      </div>
                      <div class="text-sm">Lorem ipsum dolor sit amet elit sed do eiusmod.</div>
                    </button>
                  </li>
                  <li>
                    <button class="w-full h-full text-left py-3 px-4 rounded bg-white border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                      <div class="flex flex-wrap items-center justify-between mb-0.5">
                        ...
                        <span class="font-medium text-green-600">$89.00</span>
                      </div>
                      <div class="text-sm">Lorem ipsum dolor sit amet elit sed do eiusmod.</div>
                    </button>
                  </li>
